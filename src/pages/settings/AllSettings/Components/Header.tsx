...
const Header: React.FC = () => {
  ...
  return (
    <div className={`px-4 flex flex-col gap-4 transition-all duration-300 ease-in-out bg-transparent ${deviceInfo?.isMobile ? `fixed top-[60px] py-2 left-0 w-full z-50` : "py-6 relative"}`}>
