  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        orangeVar: "rgb(var(--orange))",
        // pink: "rgb(var(--pink))",
        pinkVar: "rgb(var(--pink))",
        // teal: "rgb(var(-teal))",
        tealVar: "rgb(var(--teal))",
        // purple: "rgb(var(--purple))",
        purpleVar: "rgb(var(--purple))",
        ...
        redVar: "rgb(var(--red))",
        // blue: "rgb(var(--blue))",
        blueVar: "rgb(var(--blue))",
        // green: "rgb(var(--green))",
        greenVar: "rgb(var(--green))",
        // cyan: "rgb(var(--cyan))",
        cyanVar: "rgb(var(--cyan))",
        // indigo: "rgb(var(--indigo))",
        indigoVar: "rgb(var(--indigo))",
        // yellow: "rgb(var(--yellow))",
        yellowVar: "rgb(var(--yellow))",
