...
interface PartySummarySalesOrder {

  from: Date
}
const PartySummarySalesOrder = () => {
  ...
  const [filter, setFilter] =useState<PartySummarySalesOrder>({from: new Date()});
...
export default PartySummarySalesOrder;