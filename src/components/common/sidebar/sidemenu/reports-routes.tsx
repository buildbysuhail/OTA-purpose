...
export const ReportsMenuItems = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 162, path: `${import.meta.env.BASE_URL}reports/_/inventory/void_report`, type: 'link', active: false, selected: false, title: 'void_report', icon: PiPackageLight },
      { id: 163, path: `${import.meta.env.BASE_URL}reports/_/inventory/counter_report`, type: 'link', active: false, selected: false, title: 'counter_report', icon: PiPackageLight },
      { id: 164, path: `${import.meta.env.BASE_URL}reports/_/inventory/sales_return_estimate_register_report`, type: 'link', active: false, selected: false, title: 'sales_return_estimate_register', icon: PiPackageLight },
      { id: 165, path: `${import.meta.env.BASE_URL}reports/_/inventory/diagnosis_report`, type: 'link', active: false, selected: false, title: 'diagnosis_report', icon: PiPackageLight },
      { id: 166, path: `${import.meta.env.BASE_URL}reports/_/inventory/diagnosis_report_zero_rate_productlist`, type: 'link', active: false, selected: false, title: 'diagnosis_report_zero_rate_productlist', icon: PiPackageLight },
      { id: 167, path: `${import.meta.env.BASE_URL}reports/_/inventory/diagnosis_report_post_dated_transactions`, type: 'link', active: false, selected: false, title: 'diagnosis_report_post_dated_transactions', icon: PiPackageLight },
      { id: 168, path: `${import.meta.env.BASE_URL}reports/_/inventory/diagnosis_report_sales_price_less_than_lp_cost`, type: 'link', active: false, selected: false, title: 'diagnosis_report_sales_price_less_than_lp_cost', icon: PiPackageLight },
  ...
  },
  {
    ...
    columns: 2,
    children: [
      { id: 300, path: `${import.meta.env.BASE_URL}reports/_/inventory/purchase_tax_vat`, type: 'link', active: false, selected: false, title: 'purchase_tax', icon: AiOutlineFileText },
      { id: 301, path: `${import.meta.env.BASE_URL}reports/_/inventory/sales_tax_report`, type: 'link', active: false, selected: false, title: 'sales_tax', icon: AiOutlineFileText },
      { id: 302, path: `${import.meta.env.BASE_URL}reports/_/inventory/vat_return_form`, type: 'link', active: false, selected: false, title: 'vat_return_form', icon: AiOutlineFileText },
      { id: 303, path: `${import.meta.env.BASE_URL}reports/_/inventory/vat_return_form_arabic`, type: 'link', active: false, selected: false, title: 'vat_return_form_arabic', icon: AiOutlineFileText },
      { id: 304, path: `${import.meta.env.BASE_URL}reports/_/inventory/ksa_e_invoice_summary_report`, type: 'link', active: false, selected: false, title: 'ksa_e_invoice_summary', icon: AiOutlineFileText },
      { id: 305, path: `${import.meta.env.BASE_URL}reports/_/inventory/ksa_e_invoice_detailed_report`, type: 'link', active: false, selected: false, title: 'ksa_e_invoice_detailed', icon: AiOutlineFileText },
      { id: 306, path: `${import.meta.env.BASE_URL}reports/_/inventory/gstr1b2b_report`, type: 'link', active: false, selected: false, title: 'gstr1_b2b', icon: AiOutlineFileText },
      { id: 307, path: `${import.meta.env.BASE_URL}reports/_/inventory/gstr1b2cLarge_report`, type: 'link', active: false, selected: false, title: 'gstr1_b2cLarge', icon: AiOutlineFileText },
      { id: 308, path: `${import.meta.env.BASE_URL}reports/_/inventory/gstr1b2cSmall_report`, type: 'link', active: false, selected: false, title: 'gstr1b2c_Small', icon: AiOutlineFileText },
      { id: 309, path: `${import.meta.env.BASE_URL}reports/_/inventory/gstr1cdnr_report`, type: 'link', active: false, selected: false, title: 'gstr1_cdnr', icon: AiOutlineFileText },
      { id: 310, path: `${import.meta.env.BASE_URL}reports/_/inventory/gstr1cdnur_report`, type: 'link', active: false, selected: false, title: 'gstr1_cdnur', icon: AiOutlineFileText },
      { id: 311, path: `${import.meta.env.BASE_URL}reports/_/inventory/gstr1hsnSummary_report`, type: 'link', active: false, selected: false, title: 'gstr1_summary_of_hsn', icon: AiOutlineFileText },
      { id: 312, path: `${import.meta.env.BASE_URL}reports/_/inventory/gstr1Docs_report`, type: 'link', active: false, selected: false, title: 'gstr1_docs', icon: AiOutlineFileText },
      { id: 313, path: `${import.meta.env.BASE_URL}reports/_/inventory/gstr3b_report`, type: 'link', active: false, selected: false, title: 'gstr3b', icon: AiOutlineFileText },
         ]
  },
  {
    icon: (<Boxes className="side-menu__icon side-menu" />),
    ...
    columns: 2,
    children: [
      { id: 400, path: `${import.meta.env.BASE_URL}reports/_/inventory/itemwise_purchase_summary`, type: 'link', active: false, selected: false, title: 'itemwise_purchase_summary', icon: AiOutlineFileText },
      { id: 401, path: `${import.meta.env.BASE_URL}reports/_/inventory/itemwise_purchase_return_summary`, type: 'link', active: false, selected: false, title: 'itemwise_purchase_return_summary', icon: AiOutlineFileText },
      { id: 402, path: `${import.meta.env.BASE_URL}reports/_/inventory/itemwise_purchase_order_summary`, type: 'link', active: false, selected: false, title: 'itemwise_purchase_order_summary', icon: AiOutlineFileText },
      { id: 403, path: `${import.meta.env.BASE_URL}reports/_/inventory/itemwise_purchase_estimate_summary`, type: 'link', active: false, selected: false, title: 'itemwise_purchase_estimate_summary', icon: AiOutlineFileText },
      { id: 404, path: `${import.meta.env.BASE_URL}reports/_/inventory/itemwise_purchase_quotation_summary`, type: 'link', active: false, selected: false, title: 'itemwise_purchase_quotation_summary', icon: AiOutlineFileText },
      { id: 405, path: `${import.meta.env.BASE_URL}reports/_/inventory/itemwise_purchase_return_estimate_summary`, type: 'link', active: false, selected: false, title: 'itemwise_purchase_return_estimate_summary', icon: AiOutlineFileText },
      { id: 406, path: `${import.meta.env.BASE_URL}reports/_/inventory/itemwise_sales_summary_report`, type: 'link', active: false, selected: false, title: 'itemwise_sales_summary', icon: PiPackageLight },
      { id: 407, path: `${import.meta.env.BASE_URL}reports/_/inventory/itemwise_sales_return_summary_report`, type: 'link', active: false, selected: false, title: 'itemwise_sales_return_summary', icon: PiPackageLight },
      { id: 408, path: `${import.meta.env.BASE_URL}reports/_/inventory/itemwise_sales_order_summary_report`, type: 'link', active: false, selected: false, title: 'itemwise_sales_order_summary', icon: PiPackageLight },
      { id: 409, path: `${import.meta.env.BASE_URL}reports/_/inventory/itemwise_sales_quotation_summary_report`, type: 'link', active: false, selected: false, title: 'itemwise_sales_quotation_summary', icon: PiPackageLight },
      { id: 410, path: `${import.meta.env.BASE_URL}reports/_/inventory/itemwise_sales_estimate_summary_report`, type: 'link', active: false, selected: false, title: 'itemwise_sales_estimate_summary', icon: PiPackageLight },
      { id: 411, path: `${import.meta.env.BASE_URL}reports/_/inventory/itemwise_sales_and_sales_return_summary_report`, type: 'link', active: false, selected: false, title: 'itemwise_sales_and_sales_return_summary', icon: PiPackageLight },
    ]
  },

  {
    ...
    columns: 2,
    children: [
      { id: 600, path: `${import.meta.env.BASE_URL}reports/_/inventory/daily_statement_sales`, type: 'link', active: false, selected: false, title: 'daily_statement_sales', icon: AiOutlineFileText },
      { id: 601, path: `${import.meta.env.BASE_URL}reports/_/inventory/daily_statement_purchase`, type: 'link', active: false, selected: false, title: 'daily_statement_purchase', icon: AiOutlineFileText },
      { id: 602, path: `${import.meta.env.BASE_URL}reports/_/inventory/daily_statement_all`, type: 'link', active: false, selected: false, title: 'daily_statement_all', icon: AiOutlineFileText },
    ]
  },

  {
    ...
    columns: 1,
    children: [
      { id: 500, path: `${import.meta.env.BASE_URL}reports/_/inventory/price_list_report`, type: 'link', active: false, selected: false, title: 'price_list_report', icon: TbTag },
      { id: 501, path: `${import.meta.env.BASE_URL}reports/_/inventory/daily_balance_report`, type: 'link', active: false, selected: false, title: 'daily_balance_report', icon: IoScaleOutline },
      { id: 502, path: `${import.meta.env.BASE_URL}reports/_/inventory/product_summary`, type: 'link', active: false, selected: false, title: 'product_summary', icon: AiOutlineFileText },
      { id: 503, path: `${import.meta.env.BASE_URL}reports/_/inventory/transaction_summary_report`, type: 'link', active: false, selected: false, title: 'transaction_summary', icon: PiPackageLight },
      { id: 504, path: `${import.meta.env.BASE_URL}reports/_/inventory/inventory_transaction_register_report`, type: 'link', active: false, selected: false, title: 'inventory_transaction_register', icon: PiPackageLight },
      { id: 505, path: `${import.meta.env.BASE_URL}reports/_/inventory/inventory_summary_report`, type: 'link', active: false, selected: false, title: 'inventory_summary_report', icon: PiPackageLight },
      { id: 506, path: `${import.meta.env.BASE_URL}reports/_/inventory/service_report`, type: 'link', active: false, selected: false, title: 'service_report', icon: PiPackageLight },
      { id: 507, path: `${import.meta.env.BASE_URL}reports/_/inventory/salesman_incentive_report`, type: 'link', active: false, selected: false, title: 'salesman_incentive_report', icon: PiPackageLight },
      { id: 508, path: `${import.meta.env.BASE_URL}reports/_/inventory/privilege_card_report`, type: 'link', active: false, selected: false, title: 'privilege_card', icon: PiPackageLight },
    ]
  },
