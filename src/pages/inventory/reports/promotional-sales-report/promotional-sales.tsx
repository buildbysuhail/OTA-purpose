  ...
  const columns: DevGridColumn[] = [
    ...
    },
    {
      ...
      cellRender: (
        ...
        if (exportCell != undefined) {
          const value =
            cellElement.data?.stdGross == null
              ? ""
              : getFormattedValue(cellElement.data.stdGross);
          return {
            ...exportCell,
            text: value,
            alignment: "right",
          ...
          return cellElement.data?.stdGross == null
            ? ""
            : getFormattedValue(parseFloat(cellElement.data.stdGross));
        }
      },
    },
    {
      ...
      cellRender: (
        ...
        if (exportCell != undefined) {
          const value =
            cellElement.data?.priceDiff == null
              ? ""
              : getFormattedValue(cellElement.data.priceDiff);
          return {
            ...exportCell,
            text: value,
            alignment: "right",
          ...
          return cellElement.data?.priceDiff == null
            ? ""
            : getFormattedValue(parseFloat(cellElement.data.priceDiff));
        }
      },
    },
  ];
