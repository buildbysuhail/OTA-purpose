...
const PurchaseTaxGSTDailySummary = lazy(() => import("../../../../pages/inventory/reports/common-reports/tax-gst-reports/gst-daily-summary-report"));
const PurchaseTaxGSTAdvRegisterFormat = lazy(() => import("../../../../pages/inventory/reports/common-reports/tax-gst-reports/gst-adv-register-format-report"));
const PurchaseTaxGSTRegisterFormat = lazy(() => import("../../../../pages/inventory/reports/common-reports/tax-gst-reports/gst-register-format-report"));
const PurchaseTaxGSTDetailed = lazy(() => import("../../../../pages/inventory/reports/common-reports/tax-gst-reports/gst-detailed-report"));
const PurchaseTaxGSTMonthlySummary = lazy(() => import("../../../../pages/inventory/reports/common-reports/tax-gst-reports/gst-monthly-summary-report"));
const PurchaseTaxGSTTaxwiseWithHSN = lazy(() => import("../../../../pages/inventory/reports/common-reports/tax-gst-reports/gst-taxwise-with-hsn-report"));
const PurchaseTaxGSTTaxwise = lazy(() => import("../../../../pages/inventory/reports/common-reports/tax-gst-reports/gst-taxwise-report"));
const PurchaseReturnTaxGSTSalesAndReturn = lazy(() => import("../../../../pages/inventory/reports/common-reports/tax-gst-reports/return-tax-gst-sales-and-return-report"));
const BranchTransferOut = lazy(() => import("../../../../pages/inventory/reports/stock-journal-reports/branch-transfer-reports/branch-tranfer-out-in"));
// const BranchTransferIn = lazy(() => import("../../../../pages/inventory/reports/branch-transfer-in-report/branch-tranfer-in"));
const BranchTransferSummaryOut = lazy(() => import("../../../../pages/inventory/reports/stock-journal-reports/branch-transfer-reports/branch-tranfer-summary"));
