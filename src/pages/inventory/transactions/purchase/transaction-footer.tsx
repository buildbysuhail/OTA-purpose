...
const TransactionFooter: React.FC<TransactionFooterProps> = ({
  ...
  return (
    ...
    <div
      className="z-10 fixed bottom-0 dark:bg-dark-bg bg-[#f8f8ff] shadow-lg full-available-width lg:px-3 py-2 md:px-2 me-[14px] mb-[39px]"
      style={{
        boxShadow:
          "0 -4px 6px -1px rgba(0, 0, 0, 0.1), 0 -2px 4px -1px rgba(0, 0, 0, 0.06)",
      }}
    >
      ...
      <div
        ref={dropUpRef}
        className={`w-full transition-all duration-500 ease-in-out overflow-hidden ${
          isDropUpOpen ? "max-h-[30vh] overflow-y-auto overflow-x-hidden mb-6" : "max-h-0 overflow-hidden"
        }`}
        style={{
