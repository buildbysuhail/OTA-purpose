...
const PurchaseReturnTaxGSTMonthlySummary = () => {
            ...
            <div className="grid grid-cols-1 gap-3">
              <ErpDevGrid
               ...
               {formType > 0 && , Form Type : [formType]}"
                ...
                dataUrl={Urls.purchase_return_gst_monthly_summary}
                ...
                reload={true}
                gridId="grd_purchase_return_gst_monthly_summary_report"
              />
            </div>
          </div>
        </div>
...
export default PurchaseReturnTaxGSTMonthlySummary;
