...
const PDFBarcodeDesigner: React.FC<PDFBarcodeDesignerProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Right Sidebar - Properties (simplified for brevity) */}
      <ResizableBox
        width={380}
        height={Infinity}
      ...
      >
        {/* Properties panel content - include your existing properties UI */}
        <div className="p-4 h-full">
          ...
          {/* Include all your existing properties panels here */}
          {/* Element properties */}
          {activeTab === "element" && selectedComponent && (
            <Box
              sx={{
            ...
            >
                ...
                <Box sx={{ mb: 2 }}>
                  ...
                  <Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
                    ...
                    <ERPCheckbox
                      ...
                      checked={selectedComponent.containerProps?.autoResize ?? false}
                      onChange={(e) =>
              ...
              {/* Include all other property controls for different element types */}
              {/* ... Rest of your existing property controls ... */}
            </Box>
          )}
        </div>
      </ResizableBox>
