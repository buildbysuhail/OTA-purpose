...
import { formStateTransactionIvAccTransactionsRowsUpdate, formStateMasterHandleFieldChange } from "../../reducer";
import { TransactionFormState, InvAccTransaction } from "../../transaction-types";
...
export const AdjustmentAmountManager = ({ formState, transactionType, t, handleKeyDown, closeModal, modalHeight, isMaximized }: AdjustmentAmountInputProps) => {
  ...
  return (
    <>
      <div className="flex flex-col lg:flex-row items-end gap-3 lg:gap-2 w-full mb-4 p-2 sm:p-4">
        <div className="w-full lg:w-auto">
          <label className="text-xs block mb-1">{t("led_code")}</label>
          <ERPInput
            id="ledCode"
            noLabel={true}
            ref={ledCodeInputRef}
        ...
        {isFcTrans
          ? <div className="w-full lg:w-auto">
            <label className="text-xs block mb-1">{t("fc_amount")}</label>
            <ERPInput
              id="amountFc"
              noLabel={true}
              type="number"
              className="max-w-full lg:max-w-[210px]"
        ...
        <div className="w-full lg:w-auto">
          <label className="text-xs block mb-1 lg:hidden">{t("amount")}</label>
          <label className="text-xs hidden lg:block">{t("amount")}</label>
          <ERPInput
            id="amount"
            noLabel={true}
            type="number"
        ...
        <div className="w-full lg:w-auto">
          <label className="text-xs block mb-1 lg:hidden">{t("debit_credit")}</label>
          <label className="text-xs hidden lg:block">{t("debit_credit")}</label>
          <ERPDataCombobox
            field={{
              id: "debitCredit",
              valueKey: "value",
      ...
      <div className="flex flex-col items-end mt-2 w-full">
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 py-2 px-3 bg-gray-100 rounded-md w-full sm:w-auto justify-end">
        ...
        <div className="flex items-center gap-2 px-2 py-2 w-full justify-end mt-4">
          <ERPButton
            title={t("close")}
            variant="secondary"
