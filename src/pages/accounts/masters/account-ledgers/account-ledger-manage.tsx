...
import {
  AccountLedgerData,
  initialAccountLedger,
} from "./account-ledger-types";
...
export const AccountLedgerManage = () => {
  ...
  const {
    ...
    onSuccess: useCallback(
      () =>
        dispatch(
          toggleAccountLedgerPopup({ isOpen: false, key: null, reload: true })
        ),
      [dispatch]
    ),
    onClose: useCallback(
      () =>
        dispatch(
          toggleAccountLedgerPopup({ isOpen: false, key: null, reload: false })
        ),
      [dispatch]
    ),
  ...
  useEffect(() => {
    if (
      rootState.PopupData.accountLedger.key === undefined ||
      rootState.PopupData.accountLedger.key === null
    ) {
      load();
    }
    ...
    <div className="w-full pt-4">
      <div className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-3">
        <ERPInput
          ...
          onChangeData={(data: any) =>
            handleFieldChange("ledgerCode", data.ledgerCode)
          }
        />
        <ERPInput
        ...
        <ERPInput
          ...
          onChangeData={(data: any) =>
            handleFieldChange("aliasName", data.aliasName)
          }
        />
        <ERPInput
      ...
      <div className="grid grid-cols-2 gap-4 mt-4">
        <ERPCheckbox
          ...
          onChangeData={(data: any) =>
            handleFieldChange("isBillwiseApplicable", data.isBillwiseApplicable)
          }
        />
        <ERPCheckbox
