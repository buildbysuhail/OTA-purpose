...
const ProductDetailsIndia: React.FC = React.memo(() => {
            ...
            <div className="grid grid-cols-4 gap-1 border border-gray-200 rounded-md p-2">
                ...
                <div className="grid grid-cols-2 gap-1">
                    <ERPInput
                        ...
                        type="number"
                        required={false}
                        onChangeData={(data) => handleFieldChange("product.netWeight", data.netWeight)}
                    />
                    ...
                    <ERPInput
                        ...
                        required={false}
                        onChangeData={(data) => handleFieldChange("product.unitName", data.unitName)}
                    />
                </div>
            ...
            <div className="border border-gray-200 rounded-md p-2 relative">
                ...
                <div className="flex flex-wrap items-center gap-6 mt-5">
                    ...
                    <ERPCheckbox
                        ...
                        label={t("gate_pass")}
                        onChangeData={(data) => handleFieldChange("product.gatePass", data.gatePass)}
                    />
