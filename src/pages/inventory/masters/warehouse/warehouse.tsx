  ...
  const columns: DevGridColumn[] = useMemo(() => [
    ...
    },
    {
      ...
      cellRender: (cellElement: any) => {
        return (
          <ERPGridActions
            view={{ type: "popup", action: () => toggleWarehouse({ isOpen: true, key: cellElement?.data?.id, reload: false, mode:"view" }) }}
            edit={{ type: "popup", action: () => toggleWarehouse({ isOpen: true, key: cellElement?.data?.id, reload: false, mode:"edit" }) }}
            delete={{
