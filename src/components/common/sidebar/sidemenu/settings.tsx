...
export const SettingsMenuItems = [
  ...
  // },
  {
    ...
    columns: 2,
    children: [
      { path: `${import.meta.env.BASE_URL}settings/_/account-masters/account-group`, type: 'link', active: false, selected: false, title: 'Account Group' },
      { path: `${import.meta.env.BASE_URL}settings/_/account-masters/account-ledger`, type: 'link', active: false, selected: false, title: 'Account Ledger' },
      { path: `${import.meta.env.BASE_URL}settings/_/account-masters/currency-master`, type: 'link', active: false, selected: false, title: 'Currency Master' },
      { path: `${import.meta.env.BASE_URL}settings/_/account-masters/cost-center`, type: 'link', active: false, selected: false, title: 'Cost Center' },
      { path: `${import.meta.env.BASE_URL}settings/_/account-masters/branch-ledgers`, type: 'link', active: false, selected: false, title: 'Branch Ledgers' },
      { path: `${import.meta.env.BASE_URL}settings/_/account-masters/chart-of-accounts`, type: 'link', active: false, selected: false, title: 'Chart of Accounts' },
      { path: `${import.meta.env.BASE_URL}settings/_/account-masters/chart-of-accounts/cost-center`, type: 'link', active: false, selected: false, title: 'Cost Center (Chart of Accounts)' },
      { path: `${import.meta.env.BASE_URL}settings/_/account-masters/opening-balance`, type: 'link', active: false, selected: false, title: 'Opening Balance' },
      { path: `${import.meta.env.BASE_URL}settings/_/account-masters/party-category`, type: 'link', active: false, selected: false, title: 'Party Category' },
      { path: `${import.meta.env.BASE_URL}settings/_/account-masters/supplier-customer-master`, type: 'link', active: false, selected: false, title: 'Supplier/Customer Master' },
      { path: `${import.meta.env.BASE_URL}settings/_/account-masters/cash-bank-master`, type: 'link', active: false, selected: false, title: 'Cash/Bank Master' },
      { path: `${import.meta.env.BASE_URL}settings/_/account-masters/privilege-cards`, type: 'link', active: false, selected: false, title: 'Privilege Cards' },
      { path: `${import.meta.env.BASE_URL}settings/_/account-masters/customer-supplier-ledger`, type: 'link', active: false, selected: false, title: 'Customer/Supplier Ledger' },
    ]
  },
  {
    ...
    children: [
      ...
      { path: `${import.meta.env.BASE_URL}settings/_/user-management/user-type-privileges`, type: 'link', active: false, selected: false, title: 'User Type Privileges' },
    ]
  },
  {
    icon: (<UserIcon className="side-menu__icon" />),
