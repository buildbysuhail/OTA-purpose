...
import { FooterState, HeaderState } from "../../../../Designer/interfaces";
...
const AccPremiumHeaderFooterDesigner = ({ }: FooterDesignerProps) => {
                        ...
                        />
                           ...
                           <div className="flex items-center space-x-3">
                            ...
                            <ERPSlider
                                ...
                                onChange={(value) => handleChange("header", "OrganizationFontSize", value.target.value)}
                                min={5}
                                max={28}
                                step={1}
                            />
                ...
                {headerState?.isFirstOnly &&
                    <ERPInput
                        ...
                        onChange={(e) => {
                                ...
                                handleChange("header", "headerHeight", e.target.value)
...
export default AccPremiumHeaderFooterDesigner;
