...
const PurchaseReturnTaxGSTTaxwise = () => {
            ...
            <div className="grid grid-cols-1 gap-3">
              <ErpDevGrid
               ...
               {formType > 0 && , Form Type : [formType]}"
                ...
                dataUrl={Urls.purchase_return_gst_taxwise}
                ...
                reload={true}
                gridId="grd_purchase_return_gst_taxwise_report"
              />
            </div>
          </div>
        </div>
...
export default PurchaseReturnTaxGSTTaxwise;
