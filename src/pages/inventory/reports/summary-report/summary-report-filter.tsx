          ...
          field={{
            ...
            getListUrl: clientSession.isAppGlobal
              ...
              params: clientSession.isAppGlobal ? `voucherType=${
                location.pathname.includes("inventory/purchase_summary_report") ? "PI" 
                :location.pathname.includes("inventory/purchase_return_summary") ? "PR" 
                :location.pathname.includes("inventory/purchase_estimate_summary") ? "PE" 
                :location.pathname.includes("inventory/purchase_order_summary") ? "PO" 
                :location.pathname.includes("inventory/purchase_return_estimate_summary_report") ? "PRE" 
                :location.pathname.includes("inventory/sales_summary_report") ? "SI" 
                :location.pathname.includes("inventory/sales_return_summary") ? "SR" 
