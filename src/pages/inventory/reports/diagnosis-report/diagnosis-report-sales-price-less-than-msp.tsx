...
const DiagnosisReportSalesPriceLessthanMSP = () => {
          ...
          <div className="px-4 pt-4 pb-2 ">
            <div className="grid grid-cols-1 gap-3">
              <ErpDevGrid
                ...
                columns={columns}
                moreOption={true}
                gridHeader={t("diagnosis_report_sales_price_less_than_msp")}
                dataUrl={Urls.diagnosis_report_sales_price_less_than_msp}
                ...
                reload={true}
                gridId="grd_diagnosis_report_sales_price_less_than_msp"
              />
            </div>
          </div>
        </div>
...
export default DiagnosisReportSalesPriceLessthanMSP;