                  ...
                  <div key="mainGeneral" className="space-y-4">
                    ...
                    <div className="border p-4 flex flex-col gap-6 rounded-lg">
                      ...
                      <div className="grid xxl:grid-cols-4 lg:grid-cols-3 sm:grid-cols-2 gap-6">
                        ...
                        />
                        {settings.branchSettings?.fileAttachmentMethod && settings.branchSettings?.fileAttachmentMethod == "File System" &&
                          <ERPInput
            ...
            <section
              ...
              <div key="inventorySales" ref={el => subItemsRef.current["inventorySales"] = el}>
                ...
                <div key="inventorySales" className="space-y-4">
                  ...
                  <div className="grid xxl:grid-cols-5 lg:grid-cols-2 sm:grid-cols-3 gap-6">
                    <ERPDataCombobox
                      id="defaultSalesAcc"
                      data={settings?.inventorySettings}
                      field={{
                  ...
                  <div className="grid xxl:grid-cols-3 lg:grid-cols-2 sm:grid-cols-3 gap-6">
                    <ERPDataCombobox
