      ...
      <div className="w-full bordered-tab relative pb-16">
        ...
        <Tabs value={activeTab} onChange={handleTabChange}>
          ...
          {userSession.countryId != Countries.India &&
            applicationSettings.branchSettings.maintainKSA_EInvoice == true && (
          ...
          <div className="flex items-start space-x-3">
            <div className="flex flex-col space-y-4 basis-1/3">
              <div className="grid grid-cols-2  gap-2">
                <ERPInput
                  id="projectName"
                  value={projectOrJob.projectName}
                  data={projectOrJob}
             ...
             <div className="h-[250px] basis-2/3 bg-slate-400">
