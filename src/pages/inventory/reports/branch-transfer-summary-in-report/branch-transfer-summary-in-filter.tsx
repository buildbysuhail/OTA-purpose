...
const BranchTransferSummaryInFilter = ({ getFieldProps, handleFieldChange, formState }: any) => {
...
export default BranchTransferSummaryInFilter;
export const BranchTransferSummaryInFilterInitialState = {
