...
export const ReportsMenuItems :NavigationParentItem[]= [
...

  {
    ...
    children: [
      ...
      { id: 104, element: <DailySummaryGlobal />, formCode: "DSUMRPT", action: UserAction.Show, path: `/reports/_/accounts/daily_summary_report`, type: 'link', active: false, selected: false, title: 'daily_summary_report___', icon: CalendarClock,  routePath: ""},
  ...
  },
  {
    ...
    children: [
      ...
      { id: 304, element: <TaxReportSummary dataUrl={urls.sales_tax_report_summary} gridHeader="sales_tax_report_summary" gridId="grd_sales_tax_summary" />, formCode: "RPTSITAX", action: UserAction.Show, path: `/reports/_/inventory/sales_tax_report_summary`, type: 'link', active: false, selected: false, title: 'sales_tax_report_summary', icon: PiPackageLight,  routePath: ""},
  ...
  },
 {
   ...
   //show only when Settings.InventorySettings.autoSyncSIandPI_BT (in mscellaneous and settings visible only on global)
  {
    ...
    children: [
      ...
      { id: 401, element: <RegisterReport dataUrl={urls.sales_transfer_register} gridHeader="sales_transfer_register" gridId="grd_sales_transfer_register" />, formCode:"RPTSITRNRS", action: UserAction.Show,  path: `/reports/_/inventory/sales_transfer_register_report`, type: 'link', routePath:'', active: false, selected: false, title: 'sales_transfer_register', icon: GiReceiveMoney },
      ...
      { id: 404, element: <SalesTransferMonthWiseSummaryReport dataUrl={urls.sales_transfer_monthWise_summary} gridHeader="sales_transfer_monthWise_summary" gridId="grd_sales_transfer_monthWise_summary" />, formCode:"RPTSITRNRS", action: UserAction.Show,  path: `/reports/_/inventory/sales_transfer_monthWise_summary_report`, type: 'link', routePath:'', active: false, selected: false, title: 'sales_transfer_monthWise_summary', icon: FaSackDollar },
  ...
  },
 {
    ...
    columns: 2,
    children: [
    { id: 1400, element: <DiagnosisDynamicReport dataUrl={urls.diagnosis_report_sales_price_category_greater_than_mrp} gridHeader="diagnosis_report_sales_price_category_greater_than_mrp" gridId="grd_diagnosis_report_sales_price_category_greater_than_mrp" />, formCode: "INVPR", action: UserAction.Show, path: `/reports/_/inventory/diagnosis_report_sales_price_category_greater_than_mrp`, type: 'link', active: false, selected: false, title: 'sales_price_category_greater_than_mrp___', icon: PiPackageLight,  routePath: ""},  
    ...
    { id: 1402, element: <DiagnosisReport dataUrl={urls.diagnosis_report_of_zero_mrp_product_list} gridHeader="diagnosis_report_of_zero_mrp_product_list" gridId="grd_diagnosis_report_of_zero_mrp_product_list" />, formCode: "INVPR", action: UserAction.Show, path: `/reports/_/inventory/diagnosis_report_of_zero_mrp_product_list`, type: 'link', active: false, selected: false, title: 'zero_mrp_product_list___', icon: PiPackageLight,routePath: ""},
  ]
 },
];