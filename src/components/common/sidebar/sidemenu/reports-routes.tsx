...
export const ReportsMenuItems: NavigationParentItem[] = [
  ...
  },
  {
    ...
    children: [
     ...
     { id: 1911, element: <SummaryReport dataUrl={urls.transaction_summary} gridHeader="substitute_summary" gridId="grd_substitute_summary" voucherType="SUB" />, formCode: "INVTRSUM", action: UserAction.Show, path: `/reports/_/inventory/substitute_summary`, type: 'link', routePath: '', active: false, selected: false, title: 'substitute_summary', icon: PiUsersThreeLight },
