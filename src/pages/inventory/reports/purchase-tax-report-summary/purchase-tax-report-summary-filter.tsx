...
const PurchaseTaxReportSummaryFilter = ({
    getFieldProps,
    handleFieldChange,
    formState,
}: any) => {
        ...
        <div className="grid grid-cols-1 gap-4">
            ...
            <div className="grid items-center grid-cols-2 gap-4">
                ...
                <ERPInput
                    ...
                    onChangeData={(data: any) => handleFieldChange("vatPercentage", parseFloat(data.vatPercentage))}
                />
            </div>
        </div>
    );
...
export default PurchaseTaxReportSummaryFilter;

export const PurchaseTaxReportSummaryFilterInitialState = {
