...
const UserActionReportFilter: React.FC = React.memo(() => {
  ...
  const {
    ...
    onSuccess: useCallback(() => dispatch(toggleUserActionPopup({ isOpen: false, key: null, reload: false })), [dispatch]),
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2  gap-3">
        ...
        <div className="flex justify-start gap-3">
          ...
          <ERPDataCombobox
            ...
            onChangeData={(data: any) => { handleFieldChange("transactionType", data) }}
          />
        </div>
        <div className="flex justify-start gap-3">
          <ERPCheckbox
          ...
          <ERPDataCombobox
            ...
            onChangeData={(data: any) => { handleFieldChange("action", data) }}
          />
        </div>
      </div>
      <ERPFormButtons
