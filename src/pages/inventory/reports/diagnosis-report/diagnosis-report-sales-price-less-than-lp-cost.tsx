...
interface DiagnosisReportSalesPriceLessThanLPCostItem {
  code: string;
  autoBarcode: number;
...
const DiagnosisReportSalesPriceLessThanLPCost = () => {
          ...
          <div className="px-4 pt-4 pb-2 ">
            <div className="grid grid-cols-1 gap-3">
              <ErpDevGrid
                ...
                reload={true}
                gridId="grd_diagnosis_report_sales_price_less_than_lp_cost"
              />
            </div>
          </div>
        </div>
...
export default DiagnosisReportSalesPriceLessThanLPCost;