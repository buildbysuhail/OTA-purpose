  ...
  const columns: DevGridColumn[] = useMemo( () => [
      ...
      },
      {
        ...
        cellRender: (cellElement: any) => {
          return (
            <ERPGridActions
              view={{ type: "popup", action: () => toggleProductCategory({ isOpen: true, key: cellElement?.data?.id }) }}
              edit={{ type: "popup", action: () => toggleProductCategory({ isOpen: true, key: cellElement?.data?.id }) }}
              delete={{
