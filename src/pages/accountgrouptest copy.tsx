...
import { AccountGroupManage } from "./accounts/masters/account-groups/account-group-manage";

const AccountGroupTypeTest = () => {
...
export default React.memo(AccountGroupTypeTest);
// export default AccountGroupTypeTest;
