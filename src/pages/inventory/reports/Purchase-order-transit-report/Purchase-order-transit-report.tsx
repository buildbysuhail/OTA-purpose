...
import PurchaseOrderTransitReportFilter, {
  PurchaseOrderTransitReportInitialState,
} from "./Purchase-order-transit-report-filter";
        ...
        if (exportCell != undefined) {
          const value =
            cellElement.data?.stockInWarehouse == null
              ? ""
              : getFormattedValue(
                  Number.parseFloat(cellElement.data.stockInWarehouse),
                  false,
                  4
                );
          return {
          ...
          return cellElement.data?.stockInWarehouse == null
            ? ""
            : getFormattedValue(
                Number.parseFloat(cellElement.data.stockInWarehouse),
                false,
        ...
        if (exportCell != undefined) {
          const value =
            cellElement.data?.stockInTransit == null
              ? ""
              : getFormattedValue(
                  Number.parseFloat(cellElement.data.stockInTransit),
                  false,
                  4
                );
          return {
          ...
          return cellElement.data?.stockInTransit == null
            ? ""
            : getFormattedValue(
                Number.parseFloat(cellElement.data.stockInTransit),
                false,
        ...
        if (exportCell != undefined) {
          const value =
            cellElement.data?.orderPending == null
              ? ""
              : getFormattedValue(
                  Number.parseFloat(cellElement.data.orderPending),
                  false,
                  4
                );
          return {
          ...
          return cellElement.data?.orderPending == null
            ? ""
            : getFormattedValue(
                Number.parseFloat(cellElement.data.orderPending),
                false,
        ...
        if (exportCell != undefined) {
          const value =
            cellElement.data?.total == null
              ? ""
              : getFormattedValue(
                  Number.parseFloat(cellElement.data.total),
                  false,
                  4
                );
          return {
        ...
        if (exportCell != undefined) {
          const value =
            cellElement.data?.orderManual == null
              ? ""
              : getFormattedValue(
                  Number.parseFloat(cellElement.data.orderManual),
                  false,
                  4
                );
          return {
          ...
          return cellElement.data?.orderManual == null
            ? ""
            : getFormattedValue(
                Number.parseFloat(cellElement.data.orderManual),
                false,
