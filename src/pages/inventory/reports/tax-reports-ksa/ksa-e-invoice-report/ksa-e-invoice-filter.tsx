    ...
    <div className="grid grid-cols-1 gap-4 overflow-y-hidden overflow-x-hidden">
      ...
      <div className="flex flex-wrap sm:flex-nowrap flex-col sm:flex-row items-center gap-4">
        <div className="w-full">
          <span className="font-medium text-[#8b8b8b]">
            {t("transactions")}
          </span>
          <div className="flex flex-col sm:flex-row items-left sm:items-center justify-between gap-4 p-4 rounded border border-[#ccc] rounded-md w-full mt-1">
            <ERPCheckbox
              ...
              label={t("invoice")}
              onChangeData={(data: any) =>
                handleFieldChange("includeSI", data.includeSI)
              }
            />
            <ERPCheckbox
              ...
              onChangeData={(data: any) =>
                handleFieldChange("includeSR", data.includeSR)
              }
            />
            <ERPCheckbox
              ...
              className="w-full whitespace-nowrap"
              onChangeData={(data: any) =>
                handleFieldChange("includeDN", data.includeDN)
              }
            />
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className="flex flex-col sm:flex-row items-left sm:items-center justify-between gap-4 p-4 rounded border border-[#ccc] rounded-md w-full mt-1">
            <ERPCheckbox
              ...
              label={t("passed")}
              onChangeData={(data: any) =>
                handleFieldChange("passed", data.passed)
              }
            />
            <ERPCheckbox
              ...
              label={t("failed")}
              onChangeData={(data: any) =>
                handleFieldChange("failed", data.failed)
              }
            />
            <ERPCheckbox
              {...getFieldProps("other")}
              label={t("other")}
              onChangeData={(data: any) =>
                handleFieldChange("other", data.other)
              }
            />
          </div>
        </div>
