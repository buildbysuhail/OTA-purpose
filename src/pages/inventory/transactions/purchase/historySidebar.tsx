    ...
    () => [
      {
        ...
        cellRender: (cellElement: any) => {
          ...
          return (
            <div className="relative group bg-gradient-to-br from-[#ffffff] via-[#f8fafc]/80 to-[#eff6ff]/30 dark:from-[#0f172a] dark:via-[#1e293b]/90 dark:to-[#1e40af]/20 p-4 border border-[#e2e8f0]/60 dark:border-[#334155]/60 shadow-sm hover:shadow-lg hover:shadow-[#3b82f6]/10 dark:hover:shadow-[#60a5fa]/5 transition-all duration-300 hover:border-[#3b82f6]/60 dark:hover:border-[#60a5fa]/40 backdrop-blur-sm overflow-hidden">
