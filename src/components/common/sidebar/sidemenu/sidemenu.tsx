...
export const MENUITEMS = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: `${import.meta.env.BASE_URL}accounts/transactions/cash-receipts`, type: 'link', active: false, selected: false, title: 'cash_receipts' },
      { path: `${import.meta.env.BASE_URL}accounts/transactions/bank-payment-contra`, type: 'link', active: false, selected: false, title: 'bank_payment_contra' },
      { path: `${import.meta.env.BASE_URL}accounts/transactions/bank-receipt-contra`, type: 'link', active: false, selected: false, title: 'bank_receipt_contra' },
      { path: `${import.meta.env.BASE_URL}accounts/transactions/opening-balance`, type: 'link', active: false, selected: false, title: 'opening_balance' },
      { path: `${import.meta.env.BASE_URL}accounts/transactions/journal-entry`, type: 'link', active: false, selected: false, title: 'journal_entry' },
      { path: `${import.meta.env.BASE_URL}accounts/transactions/debit-note`, type: 'link', active: false, selected: false, title: 'debit_note' },
      { path: `${import.meta.env.BASE_URL}accounts/transactions/credit-note`, type: 'link', active: false, selected: false, title: 'credit_note' },
      { path: `${import.meta.env.BASE_URL}accounts/transactions/bank-reconciliation`, type: 'link', active: false, selected: false, title: 'bank_reconciliation' },
      { path: `${import.meta.env.BASE_URL}accounts/transactions/closing-balance`, type: 'link', active: false, selected: false, title: 'closing_balance' },
      { path: `${import.meta.env.BASE_URL}accounts/transactions/multi-journal-entry`, type: 'link', active: false, selected: false, title: 'multi_journal_entry' },
      { path: `${import.meta.env.BASE_URL}accounts/transactions/tax-on-expense`, type: 'link', active: false, selected: false, title: 'tax_on_expense' },
