...
const SearchCommon: React.FC<{ isMaximized?: boolean; modalHeight?: any, isGlobal?: boolean, isView: boolean; }> = React.memo(({ isMaximized, modalHeight, isGlobal, isView }) => {
  ...
  const columns: DevGridColumn[] = useMemo(() => [
    ...
    },
    {
      ...
      cellRender: (
        ...
        if (exportCell != undefined) {
          const value = cellElement.data?.salesPrice == null ? "" : getFormattedValue(Number.parseFloat(cellElement.data.salesPrice), false, 4);
          return { ...exportCell, text: value, alignment: "right", alignmentExcel: { horizontal: "right" }, };
        } else {
          return cellElement.data?.salesPrice == null ? "" : getFormattedValue(Number.parseFloat(cellElement.data.salesPrice), false, 4);
        }
      },
    },
    {
      ...
      cellRender: (
        ...
        return cellElement.data?.purchasePrice == null ? "" : getFormattedValue(Number.parseFloat(cellElement.data.purchasePrice), false, 4);
      }
    },
    {
      dataField: "brandName",
    ...
    },
    {
      ...
      cellRender: (
        ...
        return cellElement.data?.stock == null ? "" : getFormattedValue(Number.parseFloat(cellElement.data.stock), false, 4);
      }
    },
    {
      dataField: "isActive",
    ...
    },
    {
      ...
      cellRender: (
        cellElement: any,
        cellInfo: any
      ) => { return cellElement.data?.reOrderLevel == null ? "" : getFormattedValue(Number.parseFloat(cellElement.data.reOrderLevel), false, 4); }
    },
    {
      ...
      cellRender: (
        cellElement: any,
        cellInfo: any
      ) => { return cellElement.data?.reOrderQty == null ? "" : getFormattedValue(Number.parseFloat(cellElement.data.reOrderQty), false, 4); }
    },
    {
      dataField: "canSell",
      caption: t("can_sell"),
    ...
    },
    {
      ...
      cellRender: (
        cellElement: any,
        cellInfo: any
      ) => { return cellElement.data?.stockMin == null ? "" : getFormattedValue(Number.parseFloat(cellElement.data.stockMin), false, 4); }
    },
    {
      dataField: "stockMax",
      caption: t("stock_max"),
      ...
      cellRender: (
        cellElement: any,
        cellInfo: any
      ) => { return cellElement.data?.stockMax == null ? "" : getFormattedValue(Number.parseFloat(cellElement.data.stockMax), false, 4); }
    },
    {
    ...
    },
    {
      ...
      cellRender: (
        cellElement: any,
        cellInfo: any
      ) => { return cellElement.data?.netWt == null ? "" : getFormattedValue(Number.parseFloat(cellElement.data.netWt), false, 4); }
    },
    {
      dataField: "unitName",
      caption: t("unit_name"),
