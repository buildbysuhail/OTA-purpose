...
export const ReportsMenuItems :NavigationParentItem[]= [
  ...
  //   columns: 2,
  //   children: [
  //     { id: 100,element:<TransactionReport />, formCode:"TRANSRPT", action: UserAction.Show, path: `/reports/_/accounts/transaction_report`, type: 'link', routePath:'', active: false, selected: false, title: 'transaction_report', icon: FiFileText },
  //     { id: 101,element:<AccountsHistoryReport />, formCode:"RPTTRAHST", action: UserAction.Show, path: `/reports/_/accounts/transaction_history_accounts`, type: 'link', routePath:'', active: false, selected: false, title: 'transaction_history_accounts', icon: LuHistory },
  //     { id: 102,element:<InventoryHistoryReport />, formCode:"RPTTRAHST", action: UserAction.Show, path: `/reports/_/accounts/transaction_history_inventory`, type: 'link', routePath:'', active: false, selected: false, title: 'transaction_history_inventory', icon: MdOutlineManageHistory },
  //     { id: 103,element:<DailySummaryMaster />, formCode:"DSUMRPT", action: UserAction.Show, path: `/reports/_/accounts/daily_summary_report`, type: 'link', routePath:'', active: false, selected: false, title: 'daily_summary_report', icon: CalendarClock },
  //     { id: 104,element:<DailySummaryGlobal />, formCode:"DSUMRPT", action: UserAction.Show, path: `/reports/_/accounts/daily_summary_report`, type: 'link', routePath:'', active: false, selected: false, title: 'daily_summary_report___', icon: CalendarClock },
  //     { id: 105,element:<BillwiseProfit />, formCode:"PFTRPT", action: UserAction.Show, path: `/reports/_/accounts/billwise_profit`, type: 'link', routePath:'', active: false, selected: false, title: 'billwise_profit_report', icon: ChartNoAxesCombined },
  //     { id: 106,element:<BillwiseProfitGlobal />, formCode:"PFTRPT", action: UserAction.Show, path: `/reports/_/accounts/billwise_profit`, type: 'link', routePath:'', active: false, selected: false, title: 'billwise_profit_report__', icon: ChartNoAxesCombined },
  //     { id: 107,element:<PartySummaryMaster />, formCode:"PRTSUM", action: UserAction.Show, path: `/reports/_/accounts/partywise_summary`, type: 'link', routePath:'', active: false, selected: false, title: 'partywise_summary_report', icon: Component },
  //     { id: 108,element:<OutstandingAccountPayableReport />, formCode:"RPTACCPAY", action: UserAction.Show, path: `/reports/_/accounts/outstanding_payable`, type: 'link', routePath:'', active: false, selected: false, title: 'account_payable', icon: LucideCreditCard },
  //     { id: 109,element:<OutstandingAccountReceivableReport />, formCode:"RPTACCREC", action: UserAction.Show, path: `/reports/_/accounts/outstanding_receivable`, type: 'link', routePath:'', active: false, selected: false, title: 'account_receivable', icon: LucideDollarSign },
  //     { id: 110,element:<OutstandingAccountPayableAgingReport />, formCode:"APAGINGRPT", action: UserAction.Show, path: `/reports/_/accounts/outstanding_aging_payable`, type: 'link', routePath:'', active: false, selected: false, title: 'account_payable_aging_report', icon: Clock1Icon },
  //     { id: 111,element:<OutstandingAccountReceivableAgingReport />, formCode:"ARAGINGRPT", action: UserAction.Show, path: `/reports/_/accounts/outstanding_aging_receivable`, type: 'link', routePath:'', active: false, selected: false, title: 'account_receivable_aging_report', icon: Calendar },
  //     { id: 112,element:<LedgerReport />, formCode:"LEDGRRPT", action: UserAction.Show, path: `/reports/_/accounts/ledger_report`, type: 'link', routePath:'', active: false, selected: false, title: 'ledger_report', icon: IoBookOutline },
  //     { id: 113,element:<CashBookSummary />, formCode:"CPRPT", action: UserAction.Show, path: `/reports/_/accounts/cash_book`, type: 'link', routePath:'', active: false, selected: false, title: 'cash_book', icon: FaCoins },
  //     { id: 114,element:<DayBookDetailed />, formCode:"DBRPT", action: UserAction.Show, path: `/reports/_/accounts/day_book_detailed`, type: 'link', routePath:'', active: false, selected: false, title: 'day_book_detailed', icon: BookCopy },
  //     { id: 115,element:<DayBookSummary />, formCode:"DBRPT", action: UserAction.Show, path: `/reports/_/accounts/day_book_summary`, type: 'link', routePath:'', active: false, selected: false, title: 'day_book_summary', icon: MdLibraryBooks },
  //     { id: 116,element:<PaymentReport />, formCode:"PAYMRPT", action: UserAction.Show, path: `/reports/_/accounts/payment_report`, type: 'link', routePath:'', active: false, selected: false, title: 'payment_report', icon: MdOutlinePayments },
  //     { id: 117,element:<CollectionReport />, formCode:"COLLRPT", action: UserAction.Show, path: `/reports/_/accounts/collection_report`, type: 'link', routePath:'', active: false, selected: false, title: 'collection_report', icon: BsCollection },
  //     { id: 118,element:<CashSummary />, formCode:"RPTCASHSUM", action: UserAction.Show, path: `/reports/_/accounts/cash_summary`, type: 'link', routePath:'', active: false, selected: false, title: 'cash_summary_report', icon: GrDocumentStore },
  //     { id: 119,element:<CashSummaryLedgerwise />, formCode:"RPTCASHSUM", action: UserAction.Show, path: `/reports/_/accounts/cash_summary_ledgerwise`, type: 'link', routePath:'', active: false, selected: false, title: 'cash_summary_ledgerwise_report', icon: TbCoins },
  //   ]
  // },
  ...
  //     { id: 701,element:<StockTransfer />, formCode:"STRPT", action: UserAction.Show, path: `/reports/_/inventory/stock_transfer_report`, type: 'link', routePath:'', active: false, selected: false, title: 'stock_transfer', icon: PiPackageLight },
  //     { id: 702,element:<DamageStock />, formCode:"DMGRPT", action: UserAction.Show, path: `/reports/_/inventory/damage_stock_report`, type: 'link', routePath:'', active: false, selected: false, title: 'damage_stock', icon: PiPackageLight },
  //     { id: 703,element:<ExcessStock />, formCode:"EXRPT", action: UserAction.Show, path: `/reports/_/inventory/excess_stock_report`, type: 'link', routePath:'', active: false, selected: false, title: 'excess_stock', icon: PiPackageLight },
  //     { id: 704,element:<ShortageStock />, formCode:"SHRPT", action: UserAction.Show, path: `/reports/_/inventory/shortage_stock_report`, type: 'link', routePath:'', active: false, selected: false, title: 'shortage_stock', icon: PiPackageLight },
  //     { id: 705,element:<BranchTransferOut />, formCode:"BTORPT", action: UserAction.Show, path: `/reports/_/inventory/branch_transfer_out_report`, type: 'link', routePath:'', active: false, selected: false, title: 'branch_transfer_out', icon: PiPackageLight },
  //     { id: 706,element:<BranchTransferIn />, formCode:"BTIRPT", action: UserAction.Show, path: `/reports/_/inventory/branch_transfer_in_report`, type: 'link', routePath:'', active: false, selected: false, title: 'branch_transfer_in', icon: PiPackageLight },
  //     { id: 707,element:<BranchTransferSummaryOut />, formCode:"BTOSRPT", action: UserAction.Show, path: `/reports/_/inventory/branch_transfer_summary_out_report`, type: 'link', routePath:'', active: false, selected: false, title: 'branch_transfer_summary_out', icon: PiPackageLight },
  //     { id: 708,element:<BranchTransferSummaryIn />, formCode:"BTISRPT", action: UserAction.Show, path: `/reports/_/inventory/branch_transfer_summary_in_report`, type: 'link', routePath:'', active: false, selected: false, title: 'branch_transfer_summary_in', icon: PiPackageLight },
  //     { id: 711,element:<ItemWiseSummaryReport dataUrl={urls.itemwise_opening_stock_summary} gridHeader="itemwise_opening_stock_summary" gridId="grd_itemwise_opening_stock_summary" />, formCode:"OSRPTIWS", action: UserAction.Show, path: `/reports/_/inventory/itemwise_opening_stock_summary_report`, type: 'link', routePath:'', active: false, selected: false, title: 'itemwise_opening_stock_summary', icon: PiPackageLight },
  //     { id: 712,element:<ItemWiseSummaryReport dataUrl={urls.itemwise_substitute_summary} gridHeader="itemwise_substitute_summary" gridId="grd_itemwise_substitute_summary" />, formCode:"SUBRPTIWS", action: UserAction.Show, path: `/reports/_/inventory/itemwise_substitute_summary_report`, type: 'link', routePath:'', active: false, selected: false, title: 'itemwise_substitute_summary', icon: PiPackageLight },
  //     { id: 713,element:<ItemWiseSummaryReport dataUrl={urls.itemwise_branch_transfer_out_summary} gridHeader="itemwise_branch_transfer_out_summary" gridId="grd_itemwise_branch_transfer_out_summary" />, formCode:"BTORPTIWS", action: UserAction.Show, path: `/reports/_/inventory/itemwise_branch_transfer_out_summary_report`, type: 'link', routePath:'', active: false, selected: false, title: 'itemwise_branch_transfer_out_summary', icon: PiPackageLight },
  //     { id: 714,element:<ItemWiseSummaryReport dataUrl={urls.itemwise_branch_transfer_in_summary} gridHeader="itemwise_branch_transfer_in_summary" gridId="grd_itemwise_branch_transfer_in_summary" />, formCode:"BTIRPTIWS", action: UserAction.Show, path: `/reports/_/inventory/itemwise_branch_transfer_in_summary_report`, type: 'link', routePath:'', active: false, selected: false, title: 'itemwise_branch_transfer_in_summary', icon: PiPackageLight },
  //     { id: 715,element:<ItemWiseSummaryReport dataUrl={urls.itemwise_excess_summary} gridHeader="itemwise_excess_summary" gridId="grd_itemwise_excess_summary" />, formCode:"EXRPTIWS", action: UserAction.Show, path: `/reports/_/inventory/itemwise_excess_summary_report`, type: 'link', routePath:'', active: false, selected: false, title: 'itemwise_excess_summary', icon: PiPackageLight },
  //     { id: 716,element:<ItemWiseSummaryReport dataUrl={urls.itemwise_shortage_summary} gridHeader="itemwise_shortage_summary" gridId="grd_itemwise_shortage_summary" />, formCode:"SHRPTIWS", action: UserAction.Show, path: `/reports/_/inventory/itemwise_shortage_summary_report`, type: 'link', routePath:'', active: false, selected: false, title: 'itemwise_shortage_summary', icon: PiPackageLight },
  //     { id: 717,element:<ItemWiseSummaryReport dataUrl={urls.itemwise_damage_stock_summary} gridHeader="itemwise_damage_stock_summary" gridId="grd_itemwise_damage_stock_summary" />, formCode:"DMGRPTIWS", action: UserAction.Show, path: `/reports/_/inventory/itemwise_damage_stock_summary_report`, type: 'link', routePath:'', active: false, selected: false, title: 'itemwise_damage_stock_summary', icon: PiPackageLight },
  //     { id: 718,element:<ItemWiseSummaryReport dataUrl={urls.itemwise_goods_delivery_summary} gridHeader="itemwise_goods_delivery_summary" gridId="grd_itemwise_goods_delivery_summary" />, formCode:"GDRPTIWS", action: UserAction.Show, path: `/reports/_/inventory/itemwise_goods_delivery_summary_report`, type: 'link', routePath:'', active: false, selected: false, title: 'itemwise_goods_delivery_summary', icon: PiPackageLight },
  //     { id: 719,element:<ItemWiseSummaryReport dataUrl={urls.itemwise_goods_delivery_return_summary} gridHeader="itemwise_goods_delivery_return_summary" gridId="grd_itemwise_goods_delivery_return_summary" />, formCode:"DRRPTIWS", action: UserAction.Show, path: `/reports/_/inventory/itemwise_goods_delivery_return_summary_report`, type: 'link', routePath:'', active: false, selected: false, title: 'itemwise_goods_delivery_return_summary', icon: PiPackageLight },
  //     { id: 720,element:<ItemWiseSummaryReport dataUrl={urls.itemwise_goods_receipt_summary} gridHeader="itemwise_goods_receipt_summary" gridId="grd_itemwise_goods_receipt_summary" />, formCode:"GRNRPTIWS", action: UserAction.Show, path: `/reports/_/inventory/itemwise_goods_receipt_summary_report`, type: 'link', routePath:'', active: false, selected: false, title: 'itemwise_goods_receipt_summary', icon: PiPackageLight },
  //     { id: 721,element:<ItemWiseSummaryReport dataUrl={urls.itemwise_goods_receipt_return_summary} gridHeader="itemwise_goods_receipt_return_summary" gridId="grd_itemwise_goods_receipt_return_summary" />, formCode:"GRRRPTIWS", action: UserAction.Show, path: `/reports/_/inventory/itemwise_goods_receipt_return_summary_report`, type: 'link', routePath:'', active: false, selected: false, title: 'itemwise_goods_receipt_return_summary', icon: PiPackageLight },
  //     { id: 722,element:<ItemWiseSummaryReport dataUrl={urls.itemwise_goods_request_summary} gridHeader="itemwise_goods_request_summary" gridId="grd_itemwise_goods_request_summary" />, formCode:"GR_RPTIWS", action: UserAction.Show, path: `/reports/_/inventory/itemwise_goods_request_summary_report`, type: 'link', routePath:'', active: false, selected: false, title: 'itemwise_goods_request_summary', icon: PiPackageLight },
  //     { id: 723,element:<StockSummary />, formCode:"RPTSTK", action: UserAction.Show, path: `/reports/_/inventory/stock_summary_report`, type: 'link', routePath:'', active: false, selected: false, title: 'stock_summary', icon: PiPackageLight },
  //     { id: 724,element:<StockLedger />, formCode:"RPTSTKLED", action: UserAction.Show, path: `/reports/_/inventory/stock_ledger_report`, type: 'link', routePath:'', active: false, selected: false, title: 'stock_ledger', icon: HiOutlineClipboardList },
  //     { id: 725,element:<ExpiryReport />, formCode:"EXPIRYRPT", action: UserAction.Show, path: `/reports/_/inventory/expiry_report`, type: 'link', routePath:'', active: false, selected: false, title: 'expiry_report', icon: HiOutlineClipboardList },
  //     { id: 726,element:<TransactionAnalysisReport />, formCode:"TARPT", action: UserAction.Show, path: `/reports/_/inventory/transaction_analysis_report`, type: 'link', routePath:'', active: false, selected: false, title: 'transaction_analysis', icon: MdOutlineAnalytics },
  //     { id: 727,element:<StockFlow />, formCode:"RPTSTKFL", action: UserAction.Show, path: `/reports/_/inventory/stock_flow_report`, type: 'link', routePath:'', active: false, selected: false, title: 'stock_flow_report', icon: GiCargoShip },
  //   ]
  // },
  // {
  //   icon: (<Boxes className="side-menu__icon side-menu" />),
  ...
  //   columns: 2,
  //   children: [
  //     { id: 128,element:<SummaryReport dataUrl={urls.sales_summary} gridHeader="sales_summary_report" gridId="grd_sales_summary" />, formCode:"RPTSLSUM", action: UserAction.Show,  path: `/reports/_/inventory/sales_summary_report`, type: 'link', routePath:'', active: false, selected: false, title: 'sales_summary', icon: PiPackageLight },
  //     { id: 129,element:<RegisterReport dataUrl={urls.sales_register} gridHeader="sales_register_report" gridId="grd_sales_register" />, formCode:"RPTSRSUM", action: UserAction.Show,  path: `/reports/_/inventory/sales_register_report`, type: 'link', routePath:'', active: false, selected: false, title: 'sales_register', icon: PiPackageLight },
  //     { id: 130,element:<NetSalesReport dataUrl={urls.net_sales} gridHeader="net_sales_report" gridId="grd_net_sales_report" />, formCode:"RPTNTSI", action: UserAction.Show,  path: `/reports/_/inventory/net_sales_report`, type: 'link', routePath:'', active: false, selected: false, title: 'net_sales', icon: PiPackageLight },
  //     { id: 131,element:<PartyWiseReport dataUrl={urls.partywise_sales} gridHeader="partywise_sales" gridId="grd_partywise_sales" />, formCode:"RPTPRTSL", action: UserAction.Show,  path: `/reports/_/inventory/partywise_sales_report`, type: 'link', routePath:'', active: false, selected: false, title: 'partywise_sales', icon: PiPackageLight },
  //     { id: 132,element:<TaxReportSummary dataUrl={urls.sales_tax_report_summary} gridHeader="sales_tax_report_summary" gridId="grd_sales_tax_summary" />, formCode:"RPTSITAX", action: UserAction.Show,  path: `/reports/_/inventory/sales_tax_report_summary`, type: 'link', routePath:'', active: false, selected: false, title: 'sales_tax_report_summary', icon: PiPackageLight },
  //     { id: 133,element:<TaxReportDetailed dataUrl={urls.sales_tax_report_detailed} gridHeader="sales_tax_report_detailed" gridId="grd_sales_tax_report_detailed" />, formCode:"RPTSITAX", action: UserAction.Show,  path: `/reports/_/inventory/sales_tax_report_detailed`, type: 'link', routePath:'', active: false, selected: false, title: 'sales_tax_report_detailed', icon: PiPackageLight },
  //     { id: 134,element:<SummaryReport dataUrl={urls.sales_return_summary} gridHeader="sales_return_summary" gridId="grd_sales_return_summary" />, formCode:"RPTSRSUM", action: UserAction.Show,  path: `/reports/_/inventory/sales_return_summary`, type: 'link', routePath:'', active: false, selected: false, title: 'sales_return_summary', icon: PiPackageLight },
  //     { id: 135,element:<RegisterReport dataUrl={urls.sales_return_register} gridHeader="sales_return_register" gridId="grd_sales_return_register" />, formCode:"RPTSRREG", action: UserAction.Show,  path: `/reports/_/inventory/sales_return_register`, type: 'link', routePath:'', active: false, selected: false, title: 'sales_return_register', icon: PiPackageLight },
  //     { id: 136,element:<SalesAndSalesReturn />, formCode:"RPTSSR", action: UserAction.Show,  path: `/reports/_/inventory/sales_and_sales_return_report`, type: 'link', routePath:'', active: false, selected: false, title: 'sales_and_sales_return', icon: PiPackageLight },
  //     { id: 137,element:<SummaryReport dataUrl={urls.sales_order_summary} gridHeader="sales_order_summary" gridId="grd_sales_order_summary" />, formCode:"RPTORDSM", action: UserAction.Show,  path: `/reports/_/inventory/sales_order_summary_report`, type: 'link', routePath:'', active: false, selected: false, title: 'sales_order_summary', icon: PiPackageLight },
  //     { id: 138,element:<SummaryReport dataUrl={urls.sales_estimate_summary} gridHeader="sales_estimate_summary" gridId="grd_sales_estimate_summary" />, formCode:"RPTSES", action: UserAction.Show,  path: `/reports/_/inventory/sales_estimate_summary_report`, type: 'link', routePath:'', active: false, selected: false, title: 'sales_estimate_summary', icon: PiPackageLight },
  //     { id: 139,element:<SummaryReport dataUrl={urls.sales_quotation_summary} gridHeader="sales_quotation_summary" gridId="grd_sales_quotation_summary" />, formCode:"RPTSQS", action: UserAction.Show,  path: `/reports/_/inventory/sales_quotation_summary_report`, type: 'link', routePath:'', active: false, selected: false, title: 'sales_quotation_summary', icon: PiPackageLight },
  //     { id: 140,element:<SummaryReport dataUrl={urls.substitute_report} gridHeader="substitute_report" gridId="grd_substitute_report" />, formCode:"RPTSUB", action: UserAction.Show,  path: `/reports/_/inventory/substitute_report`, type: 'link', routePath:'', active: false, selected: false, title: 'substitute_report', icon: PiPackageLight },
  //     { id: 141,element:<DaywiseSummaryWithProfit />, formCode:"RPTSIDWSWP", action: UserAction.Show,  path: `/reports/_/inventory/daywise_summary_with_profit_report`, type: 'link', routePath:'', active: false, selected: false, title: 'daywise_summary_with_profit', icon: PiPackageLight },
  //     { id: 142,element:<GroupwiseSalesSummaryDevexpress />, formCode:"GRPWSSLRPT", action: UserAction.Show,  path: `/reports/_/inventory/groupwise_sales_summary_devexpress_report`, type: 'link', routePath:'', active: false, selected: false, title: 'groupwise_sales_summary_devexpress', icon: PiPackageLight },
  //     { id: 143,element:<GroupwiseSalesSummary dataUrl={urls.groupwise_sales_summary} gridHeader="groupwise_sales_summary_report" gridId="grd_groupwise_sales_summary_report_groupwise" filterInitialData={{ ...GroupwiseSalesSummaryFilterInitialState, isGroupWise: true }} />, formCode:"GRPWSSLRPT", action: UserAction.Show,  path: `/reports/_/inventory/groupwise_sales_summary_report_groupwise`, type: 'link', routePath:'', active: false, selected: false, title: 'groupwise_sales_summary_report', icon: PiPackageLight },
  //     { id: 144,element:<GroupwiseSalesSummary dataUrl={urls.groupwise_sales_summary} gridHeader="categorywise_sales_summary_report" gridId="grd_groupwise_sales_summary_report_categorywise" filterInitialData={{ ...GroupwiseSalesSummaryFilterInitialState, isCategoryWise: true }} />, formCode:"GRPWSSLRPT", action: UserAction.Show,  path: `/reports/_/inventory/groupwise_sales_summary_report_categorywise`, type: 'link', routePath:'', active: false, selected: false, title: 'categorywise_sales_summary_report', icon: PiPackageLight },
  //     { id: 145,element:<GroupwiseSalesSummary dataUrl={urls.groupwise_sales_summary} gridHeader="sectionwise_sales_summary_report" gridId="grd_groupwise_sales_summary_report_sectionwise" filterInitialData={{ ...GroupwiseSalesSummaryFilterInitialState, isSectionWise: true }} />, formCode:"GRPWSSLRPT", action: UserAction.Show,  path: `/reports/_/inventory/groupwise_sales_summary_report_sectionwise`, type: 'link', routePath:'', active: false, selected: false, title: 'sectionwise_sales_summary_report', icon: PiPackageLight },
  //     { id: 146,element:<GroupwiseSalesSummary dataUrl={urls.groupwise_sales_summary} gridHeader="brandwise_sales_summary_report" gridId="grd_groupwise_sales_summary_report_brandwise" filterInitialData={{ ...GroupwiseSalesSummaryFilterInitialState, isBrandWise: true }} />, formCode:"GRPWSSLRPT", action: UserAction.Show,  path: `/reports/_/inventory/groupwise_sales_summary_report_brandwise`, type: 'link', routePath:'', active: false, selected: false, title: 'brandwise_sales_summary_report', icon: PiPackageLight },
  //     { id: 147,element:<GroupwiseSalesSummary dataUrl={urls.groupwise_sales_summary} gridHeader="product_categorywise_sales_summary_report" gridId="grd_groupwise_sales_summary_report_product_categorywise" filterInitialData={{ ...GroupwiseSalesSummaryFilterInitialState, isProductCatWise: true }} />, formCode:"GRPWSSLRPT", action: UserAction.Show,  path: `/reports/_/inventory/groupwise_sales_summary_report_product_categorywise`, type: 'link', routePath:'', active: false, selected: false, title: 'product_categorywise_sales_summary_report', icon: PiPackageLight },
  //     { id: 148,element:<SalesmanwiseSalesAndCollection />, formCode:"RPTSIMWSAC", action: UserAction.Show,  path: `/reports/_/inventory/salesman_wise_sales_and_collection_report`, type: 'link', routePath:'', active: false, selected: false, title: 'salesman_wise_sales_and_collection', icon: PiPackageLight },
  //     { id: 149,element:<NonInvoicedGoodsDelivery />, formCode:"RPTSINIGDR", action: UserAction.Show,  path: `/reports/_/inventory/non_invoiced_goods_delivery_report`, type: 'link', routePath:'', active: false, selected: false, title: 'non_invoiced_goods_delivery', icon: PiPackageLight },
  //     { id: 150,element:<SummaryReport dataUrl={urls.booking_summary} gridHeader="booking_summary" gridId="grd_booking_summary" />, formCode:"RPTBKSSUM", action: UserAction.Show,  path: `/reports/_/inventory/booking_summary_report`, type: 'link', routePath:'', active: false, selected: false, title: 'booking_summary', icon: PiPackageLight },
  //     { id: 151,element:<PendingOrderReport />, formCode:"RPTPOR", action: UserAction.Show,  path: `/reports/_/inventory/pending_order_report`, type: 'link', routePath:'', active: false, selected: false, title: 'pending_order', icon: PiPackageLight },
  //     { id: 152,element:<PromotionalSalesReport />, formCode:"RPTPRMSIR", action: UserAction.Show,  path: `/reports/_/inventory/promotional_sales_report`, type: 'link', routePath:'', active: false, selected: false, title: 'promotional_sales', icon: PiPackageLight },
  //     { id: 153,element:<GroupedBrandwiseSales />, formCode:"RPTGRPBRDWSIR", action: UserAction.Show,  path: `/reports/_/inventory/grouped_brandwise_sales_report`, type: 'link', routePath:'', active: false, selected: false, title: 'grouped_brandwise_sales', icon: PiPackageLight },
  //     { id: 154,element:<PartyMonthwiseSummaryReport dataUrl={urls.party_monthwise_sales_summary} gridHeader="party_monthwise_sales_summary" gridId="grd_party_monthwise_sales_summary" />, formCode:"RPTPRTYMWSIS", action: UserAction.Show,  path: `/reports/_/inventory/party_monthwise_sales_summary_report`, type: 'link', routePath:'', active: false, selected: false, title: 'party_monthwise_sales_summary', icon: PiPackageLight },
  //     { id: 155,element:<CouponReports />, formCode:"COUPSALRPT", action: UserAction.Show,  path: `/reports/_/inventory/coupon_reports`, type: 'link', routePath:'', active: false, selected: false, title: 'coupon_reports', icon: PiPackageLight },
  //     { id: 156,element:<SchemeWiseSales />, formCode:"ITMSCMSRPT", action: UserAction.Show,  path: `/reports/_/inventory/scheme_wise_sales_report`, type: 'link', routePath:'', active: false, selected: false, title: 'scheme_wise_sales', icon: PiPackageLight },
  //     { id: 158,element:<RouteWiseSalesAndCollection />, formCode:"ROUTWISE_SL_CR_1", action: UserAction.Show,  path: `/reports/_/inventory/routewise_sales_collection_report`, type: 'link', routePath:'', active: false, selected: false, title: 'routewise_sales_collection', icon: PiPackageLight },
  //     { id: 159,element:<BranchInventoryRequestPendingOrder />, formCode:"ADVBRNCHPEN", action: UserAction.Show,  path: `/reports/_/inventory/branch_inventory_request_pending_order_report`, type: 'link', routePath:'', active: false, selected: false, title: 'branch_inventory_request_pending_order', icon: PiPackageLight },
  //     { id: 160,element:<PrintDetails />, formCode:"ADVPRINT", action: UserAction.Show,  path: `/reports/_/inventory/print_details_report`, type: 'link', routePath:'', active: false, selected: false, title: 'print_details', icon: PiPackageLight },
  //     { id: 161,element:<InventoryStatusReport />, formCode:"INVSTATUSRPT", action: UserAction.Show,  path: `/reports/_/inventory/inventory_status_report`, type: 'link', routePath:'', active: false, selected: false, title: 'inventory_status', icon: PiPackageLight },
  //     { id: 162,element:<VoidReport />, formCode:"RPTADVOID", action: UserAction.Show,  path: `/reports/_/inventory/void_report`, type: 'link', routePath:'', active: false, selected: false, title: 'void_report', icon: PiPackageLight },
  //     { id: 163,element:<CounterReport />, formCode:"CNTRRPT", action: UserAction.Show,  path: `/reports/_/inventory/counter_report`, type: 'link', routePath:'', active: false, selected: false, title: 'counter_report', icon: PiPackageLight },
  //     { id: 164,element:<RegisterReport dataUrl={urls.sales_return_estimate_register} gridHeader="sales_return_estimate_register" gridId="grd_sales_return_estimate_register" />, formCode:"SREREGT", action: UserAction.Show,  path: `/reports/_/inventory/sales_return_estimate_register_report`, type: 'link', routePath:'', active: false, selected: false, title: 'sales_return_estimate_register', icon: PiPackageLight },
  //     { id: 165,element:<DiagnosisReport />, formCode:"ADVDIGREPT", action: UserAction.Show,  path: `/reports/_/inventory/diagnosis_report`, type: 'link', routePath:'', active: false, selected: false, title: 'diagnosis_report', icon: PiPackageLight },
  //     { id: 166,element:<DiagnosisReportZeroRateProductlist />, formCode:"ADVDIGREPT", action: UserAction.Show,  path: `/reports/_/inventory/diagnosis_report_zero_rate_productlist`, type: 'link', routePath:'', active: false, selected: false, title: 'diagnosis_report_zero_rate_productlist', icon: PiPackageLight },
  //     { id: 167,element:<DiagnosisReportPostDatedTransactions />, formCode:"ADVDIGREPT", action: UserAction.Show,  path: `/reports/_/inventory/diagnosis_report_post_dated_transactions`, type: 'link', routePath:'', active: false, selected: false, title: 'diagnosis_report_post_dated_transactions', icon: PiPackageLight },
  //     { id: 168,element:<DiagnosisReportSalesPriceLessThanLPCost />, formCode:"ADVDIGREPT", action: UserAction.Show,  path: `/reports/_/inventory/diagnosis_report_sales_price_less_than_lp_cost`, type: 'link', routePath:'', active: false, selected: false, title: 'diagnosis_report_sales_price_less_than_lp_cost', icon: PiPackageLight },
  //     { id: 169,element:<DiagnosisReportSalesPriceLessthanPurchasePrice />, formCode:"ADVDIGREPT", action: UserAction.Show,  path: `/reports/_/inventory/diagnosis_report_sales_price_less_than_purchase_price`, type: 'link', routePath:'', active: false, selected: false, title: 'diagnosis_report_sales_price_less_than_purchase_price', icon: PiPackageLight },
  //     { id: 170,element:<DiagnosisReportSalesPriceLessthanMSP />, formCode:"ADVDIGREPT", action: UserAction.Show,  path: `/reports/_/inventory/diagnosis_report_sales_price_less_than_msp`, type: 'link', routePath:'', active: false, selected: false, title: 'diagnosis_report_sales_price_less_than_msp', icon: PiPackageLight },
  //     { id: 171,element:<DiagnosisReportSalesPriceGreaterthanMRP />, formCode:"ADVDIGREPT", action: UserAction.Show,  path: `/reports/_/inventory/diagnosis_report_sales_price_greater_than_mrp`, type: 'link', routePath:'', active: false, selected: false, title: 'diagnosis_report_sales_price_greater_than_mrp', icon: PiPackageLight },
  //     { id: 172,element:<CustomerVisitTotalVisit />, formCode:"RPTTOTVIS", action: UserAction.Show,  path: `/reports/_/inventory/customer_visit_total_visit`, type: 'link', routePath:'', active: false, selected: false, title: 'customer_visit_total_visit', icon: PiPackageLight },
  //     { id: 173,element:<CustomerVisitLastVisit />, formCode:"RPTLAVIDET", action: UserAction.Show,  path: `/reports/_/inventory/customer_visit_last_visit`, type: 'link', routePath:'', active: false, selected: false, title: 'customer_visit_last_visit', icon: PiPackageLight },
  //     { id: 174,element:<FOCRegisterReport />, formCode:"RPTFOCREG", action: UserAction.Show,  path: `/reports/_/inventory/foc_register_report`, type: 'link', routePath:'', active: false, selected: false, title: 'foc_register_report', icon: PiPackageLight },
  //     { id: 175,element:<DiscountReportInventory />, formCode:"RPTINV", action: UserAction.Show,  path: `/reports/_/inventory/discount_report_inventory`, type: 'link', routePath:'', active: false, selected: false, title: 'discount_report_inventory', icon: PiPackageLight },
  //     { id: 176,element:<DiscountReportCollection />, formCode:"RPTCOL", action: UserAction.Show,  path: `/reports/_/inventory/discount_report_collection`, type: 'link', routePath:'', active: false, selected: false, title: 'discount_report_collection', icon: PiPackageLight },
  //     { id: 177,element:<ItemUsedForService />, formCode:"ITMSFORSRV", action: UserAction.Show,  path: `/reports/_/inventory/item_used_for_service`, type: 'link', routePath:'', active: false, selected: false, title: 'item_used_for_service', icon: PiPackageLight },
  //     { id: 178,element:<LPOReport />, formCode:"LPORPT", action: UserAction.Show,  path: `/reports/_/inventory/lpo_report`, type: 'link', routePath:'', active: false, selected: false, title: 'lpo_report', icon: PiPackageLight },
