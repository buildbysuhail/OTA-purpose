  ...
  return (
    ...
    <div className={"transition-all  flex flex-col gap-5 bg-white dark:bg-dark-bg-card p-4"}>
      <div className="flex justify-between items-center  border-b dark:border-dark-border  bg-[#80808012] dark:bg-dark-bg-card p-2">
        <h6 className="dark:!text-dark-text">{t("header")}</h6>
      </div>

      <div key={`ti_head`} className="group relative w-full h-[250px] xs:h-[260px] sm:h-[280px] md:h-[300px] lg:h-[280px] aspect-[4/5] bg-white dark:bg-dark-bg-card rounded-md border border-slate-400 dark:border-dark-border hover:border-slate-600 dark:hover:border-gray-400 hover:shadow-xl overflow-hidden">
        <div className="relative w-full h-[80%] bg-gradient-to-br from-slate-50 dark:from-slate-800 to-slate-100 dark:to-slate-700 overflow-hidden">
          <img src={headerState?.customElements?.thumbImage || "/placeholder.svg?height=300&width=240"} alt={"header thumbImage"} className="w-full h-full object-contain " />
        </div>
