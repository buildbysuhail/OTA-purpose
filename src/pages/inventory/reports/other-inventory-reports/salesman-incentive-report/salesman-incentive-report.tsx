    ...
    },
    {
      ...
      cellRender: (
        ...
        if (exportCell != undefined) {
          const value =
            cellElement.data?.billAmount == null ? "" : getFormattedValue(cellElement.data.billAmount, false, 4);
          return {
            ...exportCell,
            text: value,
            alignment: "right",
          ...
          return cellElement.data?.billAmount == null ? "" : getFormattedValue(cellElement.data.billAmount, false, 4);
        }
      },
    },
    {
      ...
      cellRender: (
        ...
        if (exportCell != undefined) {
          const value =
            cellElement.data?.smIncentive == null ? "" : getFormattedValue(cellElement.data.smIncentive, false, 4);
          return {
            ...exportCell,
            text: value,
            alignment: "right",
          ...
          return cellElement.data?.smIncentive == null ? "" : getFormattedValue(cellElement.data.smIncentive, false, 4);
        }
      },
    },
  ];
          ...
          <div className="px-4 pt-4 pb-2">
            <div className="grid grid-cols-1 gap-3">
              <ErpDevGrid
                ...
                filterHeight={150}
                filterInitialData={{
                  ...SalesmanIncentiveReportFilterInitialState,
