...
export const ReportsMenuItems = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 156, path: `${import.meta.env.BASE_URL}reports/_/inventory/void_report`, type: 'link', active: false, selected: false, title: 'void_report', icon: PiPackageLight },
      { id: 156, path: `${import.meta.env.BASE_URL}reports/_/inventory/counter_report`, type: 'link', active: false, selected: false, title: 'counter_report', icon: PiPackageLight },
      { id: 156, path: `${import.meta.env.BASE_URL}reports/_/inventory/sales_return_estimate_register_report`, type: 'link', active: false, selected: false, title: 'sales_return_estimate_register', icon: PiPackageLight },
      { id: 156, path: `${import.meta.env.BASE_URL}reports/_/inventory/diagnosis_report`, type: 'link', active: false, selected: false, title: 'diagnosis_report', icon: PiPackageLight },
      { id: 156, path: `${import.meta.env.BASE_URL}reports/_/inventory/diagnosis_report_zero_rate_productlist`, type: 'link', active: false, selected: false, title: 'diagnosis_report_zero_rate_productlist', icon: PiPackageLight },
      { id: 156, path: `${import.meta.env.BASE_URL}reports/_/inventory/diagnosis_report_post_dated_transactions`, type: 'link', active: false, selected: false, title: 'diagnosis_report_post_dated_transactions', icon: PiPackageLight },
      { id: 156, path: `${import.meta.env.BASE_URL}reports/_/inventory/diagnosis_report_sales_price_less_than_lp_cost`, type: 'link', active: false, selected: false, title: 'diagnosis_report_sales_price_less_than_lp_cost', icon: PiPackageLight },
      { id: 156, path: `${import.meta.env.BASE_URL}reports/_/inventory/diagnosis_report_sales_price_less_than_purchase_price`, type: 'link', active: false, selected: false, title: 'diagnosis_report_sales_price_less_than_purchase_price', icon: PiPackageLight },
      { id: 156, path: `${import.meta.env.BASE_URL}reports/_/inventory/diagnosis_report_sales_price_less_than_msp`, type: 'link', active: false, selected: false, title: 'diagnosis_report_sales_price_less_than_msp', icon: PiPackageLight },
      { id: 156, path: `${import.meta.env.BASE_URL}reports/_/inventory/diagnosis_report_sales_price_greater_than_mrp`, type: 'link', active: false, selected: false, title: 'diagnosis_report_sales_price_greater_than_mrp', icon: PiPackageLight },
    ]
  },
  {
    icon: (<CircleUser className="side-menu__icon side-menu" />),
