  ...
  const summaryItems: SummaryConfig[] = [
    ...
    },
    {
      ...
      cellSummaryAction: (value: number) => {
        return getFormattedValue(value, false, 2);
      },
    },
    {
      column: "billDiscount",
          ...
          <div className="px-4 pt-4 pb-2 ">
            <div className="grid grid-cols-1 gap-3">
              <ErpDevGrid
                ...
                {voucherType =='SO' && Sales Order Discount Report}
                {voucherType =='SE' && Sales Estimate Discount Report} 
                {voucherType =='SQ' && Sales Quotation Discount Report} 
                {voucherType =='PE' && Purchase Estimate Discount Report}
                {voucherType =='PO' && Purchase Order Discount Report}
                {voucherType =='OS' && Opening stock Discount Report}
