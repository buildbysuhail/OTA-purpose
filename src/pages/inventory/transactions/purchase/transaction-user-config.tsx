                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      <div
                        ...
                        style={{ backgroundColor: formState.userConfig?.scrollbarColor ? `rgb(${formState.userConfig?.scrollbarColor})` : "128, 128, 128"} }>
                        <i className="ri-palette-line text-white text-sm absolute pointer-events-none drop-shadow-md"></i>
                        <input
                          type="color"
                          value={formState.userConfig?.scrollbarColor ? rgbToHex(formState.userConfig?.scrollbarColor) : "128,128,128"} //testing
                          onChange={(e) => {
