...
export const ReportsMenuItems = [
  ...
  // },
  {
    ...
    children: [
      ...
      { id: 156, path: `${import.meta.env.BASE_URL}reports/_/inventory/routewise_sales_collection_report`, type: 'link', active: false, selected: false, title: 'routewise_sales_collection', icon: PiPackageLight },
      { id: 156, path: `${import.meta.env.BASE_URL}reports/_/inventory/branch_inventory_request_pending_order_report`, type: 'link', active: false, selected: false, title: 'branch_inventory_request_pending_order', icon: PiPackageLight },
      { id: 156, path: `${import.meta.env.BASE_URL}reports/_/inventory/print_details_report`, type: 'link', active: false, selected: false, title: 'print_details', icon: PiPackageLight },
      { id: 156, path: `${import.meta.env.BASE_URL}reports/_/inventory/inventory_status_report`, type: 'link', active: false, selected: false, title: 'inventory_status', icon: PiPackageLight },
    ]
  },
  // {
  //   icon: (<CircleUser className="side-menu__icon side-menu" />),
