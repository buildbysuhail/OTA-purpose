    ...
    <div className="p-4 bg-gray-100">
      <div className="grid grid-cols-2 gap-6 mb-4">
        ...
        <div className="bg-white p-3 border border-gray-300">
          ...
          <div className="space-y-2">
            <div className="flex items-center">
              <label className="w-32 text-xs">{t("delivery_note_no")} :</label>
              <ERPInput
      ...
      <div className="grid grid-cols-2 gap-6 mb-4">
        ...
        <div className="bg-white p-3 border border-gray-300">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center">
              <label className="w-32 text-xs">{t("salesman_incentive")} :</label>
              <ERPInput
                noLabel={true}
      ...
      <div className="grid grid-cols-2 gap-6 mb-4">
        ...
        <div className="bg-white p-3 border border-gray-300">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center">
              <label className="w-32 text-xs">{t("sch_disc_posting_a/c")} :</label>
              <ERPDataCombobox
                id="tableId"
                noLabel={true}
