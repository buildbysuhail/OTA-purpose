...
const { value: orderNumberValue, onChange: onOrderNumberChange } = useDebouncedInput(
 ...
 <><ERPInput
              ...
              onChange={(e) => onOrderNumberChange(e.target.value)} /><button
    ...
    >
      <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center mb-6">
          {/* FIXED-HEIGHT LABEL */}
          <label className="w-24 mr-4 flex items-center justify-end h-10 text-sm font-medium">
            {props.t("GRN No")}:
          </label>
            ...
            <ERPDataCombobox
              ...
              onSelectItem={(e) =>
                setLoadData((prev) => {
                  return {
                    ...prev,
                    vPrefix: e.value, // Fixed: should be vPrefix, not formType
                  };
                })
              }
              field={{
