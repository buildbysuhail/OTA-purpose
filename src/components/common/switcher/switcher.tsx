                  ...
                  <div className='pickr-container-primary'>
                    <div className='pickr'>
                      <button className='pcr-button' onClick={(ele: any) => {
                        ...
                        <Themeprimarycolor appState={local_varaiable} actionfunction={updateAppState} />
                      </button>
                  ...
                  <div className='pickr-container-background'>
                    <div className='pickr'>
                      <button className='pcr-button' onClick={(ele: any) => {
                        ...
                        <switcherdata.Themebackgroundcolor appState={local_varaiable} actionfunction={updateAppState} />
                      </button>
