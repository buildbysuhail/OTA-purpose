  ...
  ({
    ...
    return (
      ...
      <ReactModal
        ...
        //  className="flexible-modal shadow-sm"
        // overlayClassName="flexible-modal-mask "
        // dragHandleClassName="flexible-modal-drag-area"
        // onRequestClose={closeModal}
        isOpen={isOpen}
        {...({} as any)} // Temporary workaround if TypeScript still complains
      >
        <div className="flex flex-col ">
        <div className="mb-10 rounded-t-md  min-w-full relative   flex justify-between text-[16px] dark:border-dark-border border-b py-3 font-medium leading-6 dark:bg-dark-bg dark:text-dark-text text-gray-900"

         // Add cursor: move
          >
            <div className="flex items-center dark:text-dark-text absolute z-[55] left-5">
              {title}
            </div>
         
            <div className="flex items-center space-x-2  absolute z-[55] right-[5px]">
              {isMaximize ? (
                <button
             ...
             {closeButton !== "Button" && ( <button
              ...
              >
               ...
               {closeButton === "Button" && (
              <div className="max-w-[200px] inline-block  absolute z-[55] right-0">
                <ERPButton
                  className="w-full"
                  type="button"
                  title={closeTitle}
