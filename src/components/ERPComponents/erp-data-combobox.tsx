...
import { Autocomplete, CircularProgress, TextField, Theme, SxProps } from "@mui/material";
          ...
          <div className={className}>
            ...
            <div className="absolute inset-y-0 right-0 flex items-center pr-1">
              ...
              <Combobox.Button
                ...
                <ChevronDownIcon
                  className={`${sizeClasses?.icons
                    } text-gray-400 hover:text-gray-500 transition-transform duration-200 ${isOpen ? "transform rotate-180" : ""
                    }`}
                  aria-hidden="true"
                />
              </Combobox.Button>
