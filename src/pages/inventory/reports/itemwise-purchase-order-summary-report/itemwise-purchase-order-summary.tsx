...
const ItemWisePurchaseOrderSummary = () => {
  const { t } = useTranslation("accountsReport");
  const [showFilter, setShowFilter] = useState<boolean>(false);
  const [filter, setFilter] = useState<any>(ItemWisePurchaseOrderSummaryFilterInitialState);
          ...
          <div className="px-4 pt-4 pb-2">
            <div className="grid grid-cols-1 gap-3">
              <ErpDevGrid
                ...
                columns={columns}
                moreOption
                gridHeader={t("item_wise_purchase_order_summary")}
                dataUrl={Urls.item_wise_purchase_order_summary}
...
export default ItemWisePurchaseOrderSummary;