import { transactionRoutes } from "../components/common/content/transaction-routes";
...
const CachedUrls: string[] = [
  ...
  ...transactionRoutes.map((x: any) => `/${x.transactionBase}/${x.transactionType}/Data/AccLedgers/`)
]
