        ...
        <DataGrid
          ...
          {gridCols?.map((column) => (
            <Column
              ...
              dataField={column.dataField}
              caption={column.captionDynamic ? column.captionDynamic(filter) : column.caption}
              ...
              visible={column.visibleDynamic ? column.visibleDynamic(filter) :  column.visible || false}
            />
          ))}
