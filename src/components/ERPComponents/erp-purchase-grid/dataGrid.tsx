          ...
          .map((column, columnIndex) => {
            ...
            return (
              <td
                ...
                className={`flex items-center p-0 ${column.cssClass || ""} ${isFocused ? "!border-[#3b82f6] bg-[#eff6ff80]" : ""}${column.allowEditing && !column.readOnly ? "hover:bg-gradient-to-r hover:from-gray-50/60 hover:to-slate-50/40 transition-all duration-150" : ""}`}
                style={{
